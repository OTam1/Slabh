...
<html class="no-js" lang="">
	...
	<body>
		...
		<section id="mainContent">
				...
				<div class="navN_close">
					...
					<nav class="main-navigation">
						<ul>
							...
							<li>
								<a href="#" class="nav-link nav-active">Services</a>
							</li>
							<li>
			...
			<article id="servicesMain">
				<h1 class="services-header header-default">Services</h1>
				<ul class="services-list clearfix">
					<li><div class="icn_container  icn_small">
						<img src="img/ServicesIcon_01.png" alt="Project Management" class="service-icon" />
					</div><span class="service-title">Project
							<br />
							Management</span>
					</li>
					<li><div class="icn_container icn_large">
						<img src="img/ServicesIcon_02.png" alt="Design Management" class="service-icon" />
					</div><span class="service-title">Contracting</span>
					</li>
					<li><div class="icn_container icn_small">
						<img src="img/ServicesIcon_03.png" alt="Contracting" class="service-icon" />
					</div><span class="service-title">Design
							<br />
							Management</span>
					</li>
				</ul>
		...
		<script defer src="js/fadeIN_services.js"></script>
