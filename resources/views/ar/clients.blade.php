		...
		<section id="mainContent">
			...
			<header id="mainHeader">
				<div class="navN_close">
					<a href='/Ar/Home' class="logo"><img src="/img/salabh.png" alt="salabh contracting" /></a>
					<nav class="main-navigation">
						<ul>
							...
							<li>
								<a href="#" class="nav-link nav-active">عملائنا</a>
							</li>
							<li>
			...
			<article id="clientsMain">
			 <h1 style="text-align: right;" class="clients-header header-default">العملاء</h1>
			 <div class="clients-data">
			 	<div class="brands_wrap">
			 		<ul class="brands-row">
			 			<li><a href="http://www.big.sa.com" class="brand-link"><img src="/img/baas.jpg" alt="" class="brand-logo" /></a></li>
			 			<li><a href="#" class="brand-link"><img src="/img/logo_1.png" alt="" class="brand-logo" /></a></li>
			 			...
			 			<li><a href="#" class="brand-link"><img src="/img/logo_09.jpg" alt="" class="brand-logo" /></a></li>
			 			...
			 			<li><a href="#" class="brand-link"><img src="/img/logo_18.jpg" alt="" class="brand-logo" /></a></li>
