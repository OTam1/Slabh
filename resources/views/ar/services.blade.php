	...
	<body>
		...
		<section id="mainContent">
				...
				<div class="navN_close">
					...
					<nav class="main-navigation">
						...
						<li>
							...
							<li>
								<a href="#" class="nav-link nav-active">الخدمات</a>
							</li>
							<li>
			...
			<article id="servicesMain">
				<h1 class="services-header header-default">الخدمات</h1>
				<ul class="services-list clearfix">

					<li><div class="icn_container icn_small">
						<img src="{{ asset('img/ServicesIcon_03.png')}}" alt="Contracting" class="service-icon" />
					</div><span class="service-title">إدارة
							<br />
							تصاميم</span>
					</li>
					...
					<li><div class="icn_container icn_large">
						<img src="{{ asset('img/ServicesIcon_02.png')}}" alt="Design Management" class="service-icon" />
					</div><span class="service-title">المقاولات</span>
					</li>

						<li><div class="icn_container  icn_small">
						<img src="{{ asset('img/ServicesIcon_01.png')}}" alt="Project Management" class="service-icon" />
					</div><span class="service-title">إدارة
							<br />
							مشاريع</span>
					</li>
