...
<html class="no-js" lang="">
	...
	<body>
		...
		<section id="mainContent">
			...
			<img class='featured-img ftdimg1' src="{{ asset('img/values_featured.jpg')}}" alt="" />
			...
			<header id="mainHeader">
				<div class="navN_close">
					...
					<nav class="main-navigation">
							...
							<li>
								<a href="#" class="nav-link nav-active">القيم</a>
							</li>
							<li>
			...
			<article id="valuesMain">
				<h1 style="text-align: right;" class="about-header header-default">القيم</h1>
				<p class="values">
