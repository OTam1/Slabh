	...
	<body>
		...
		<section id="mainContent">
				...
				<div class="navN_close">
					...
					<nav class="main-navigation">
						...
						<li>
							...
							<li>
								<a href="/Ar/about" class="nav-link nav-active">عن صلابة</a>
							</li>
							<li>
			...
			<article id="aboutMain">
				<h1 class="about-header header-default">عن صلابة</h1>
				<p class="about-data" style="text-align: right;">امتدادا للأعمال التجارية منذ 50 عاما في مجال المقاولات والعقارات.
تأسست شركة صلابة للعمل في مجال البناء وإدارة المشاريع والمجالات المعمارية.
التطلع إلى التميز وإحياء الأرض
				</p>
			</article>
