...
<html class="no-js" lang="">
	...
	<body>
		...
		<section id="mainContent">
			...
			<div class="bgimgs">
				<img src="img/small_thumb/alNakhil.jpg" id="triple1" alt="alNakhil.jpg,FahdBridge.jpg,XX.jpg" />
				<img src="img/small_thumb/Goudi.jpg" id="triple2" alt="Goudi.jpg,MishaalMasjid.jpg,Mishraq.jpg" />
				<img src="img/small_thumb/MyJourney.jpg" id="triple3" alt="MyJourney.jpg,XXXXX.jpg,okan.jpg" />
			</div>
			...
			<article id="aboutMain">
				<h1 class="about-header header-default">About SLABH</h1>
				<p class="about-data">
					An extension of the commercial business since 50 years in the construction field & real estate.
					SALABH was founded  to work in the construction., project management and architectural fields.
					Eyeing excellence and revive the earth.
				</p>
			</article>
